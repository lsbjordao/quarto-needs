...
def test_self_hosted_evidence_flow_attests_before_validation_and_render() -> None:
    ...
    assert "-m quarto_needs.cli_dispatch --root examples/quarto-needs evidence attest" in text
    ...
    assert "-m quarto_needs.cli_dispatch --root examples/quarto-needs evidence check" in text
