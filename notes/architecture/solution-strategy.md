...
The strategy is a small set of guardrails (from `notes/ROADMAP.md`) that every other architectural decision must be consistent with. This page explains *why* those guardrails hold, not just what they say.
