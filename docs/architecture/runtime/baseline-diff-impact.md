...
`impact.py` traverses the union of the baseline and current graphs and returns explicit, auditable graph paths for what changed and what it reaches, rather than an opaque numeric risk score (`docs/ROADMAP.md` guardrail 6, "change intelligence is explainable").
