...
| [`solution-strategy.md`](solution-strategy.md) | Maintainer, contributor | Cross-cutting decisions that constrain everything else | Prose + links to ADRs | `docs/ROADMAP.md` guardrails, `ADR-001`/`ADR-002`/`ADR-003` | A guardrail changes or a new one is adopted |
