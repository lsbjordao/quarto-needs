<!--
Provenance: this is the revised core-stabilization design written on the
`phase-6b-c4-ir` branch, preserved verbatim at the merge into `main`.

The version at `2026-09-02-core-stabilization-design.md` is the one `main`
actually executed (commits 7e3e49c..7a092ca). This revision argues that
scope was oversized and re-derives a smaller one. It is kept because its
evidence sections are auditable and still useful, not because it supersedes
the executed design.
-->
