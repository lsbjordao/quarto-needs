<!--
Provenance: this is the revised core-stabilization plan written on the
`phase-6b-c4-ir` branch, preserved verbatim at the merge into `main`.

Its 41 tasks were authored as if unstarted, but `main` had already landed
the equivalent work (declaration-native validation ed939ad, linear indexes
8854a65, semantic-kernel boundary c2c68e7, benchmarks a000a06). Verify
against the current tree before executing any task here.
-->
