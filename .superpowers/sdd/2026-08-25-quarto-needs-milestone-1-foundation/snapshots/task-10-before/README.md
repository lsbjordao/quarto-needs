...
`make render-example` regenera o grafo, sincroniza a extensão local e grava o
livro estático em `examples/book/_book`. `make preview-example` faz o mesmo
pré-processamento e inicia o servidor de desenvolvimento com atualização
automática.
