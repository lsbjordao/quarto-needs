...
391 lines added, 8 lines removed.

## Full diff (10 lines of context)

```diff
diff -ruN '--unified=10' .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/docs/superpowers/plans/2026-08-25-quarto-needs-milestone-3-baseline.md .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/docs/superpowers/plans/2026-08-25-quarto-needs-milestone-3-baseline.md
--- .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/docs/superpowers/plans/2026-08-25-quarto-needs-milestone-3-baseline.md	2026-08-25 21:28:57.805047471 -0300
+++ .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/docs/superpowers/plans/2026-08-25-quarto-needs-milestone-3-baseline.md	2026-08-26 01:15:55.479325417 -0300
@@ -918,22 +918,22 @@
...
+    assert doc["relations"] == ["conflicts-with"]
 ...
 def test_impact_rejects_a_configuration_mismatch_without_recompute(tmp_path: Path) -> None:
     ...
     snapshot, config = snapshot_of(tmp_path)
diff -ruN '--unified=10' .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/schemas/baseline-v1.schema.json .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/schemas/baseline-v1.schema.json
--- .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/schemas/baseline-v1.schema.json	1969-12-31 21:00:00.000000000 -0300
+++ .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/schemas/baseline-v1.schema.json	2026-08-26 01:09:31.868644198 -0300
@@ -0,0 +1,75 @@
+{
...
+  }
+}
diff -ruN '--unified=10' .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/src/quarto_needs/baseline.py .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/src/quarto_needs/baseline.py
--- .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/src/quarto_needs/baseline.py	1969-12-31 21:00:00.000000000 -0300
+++ .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/src/quarto_needs/baseline.py	2026-08-26 01:10:24.420460974 -0300
@@ -0,0 +1,147 @@
...
+        )
+    return payload
diff -ruN '--unified=10' .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/tests/test_baseline.py .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/tests/test_baseline.py
--- .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-before/tests/test_baseline.py	1969-12-31 21:00:00.000000000 -0300
+++ .superpowers/sdd/2026-08-25-quarto-needs-milestone-3-baseline/snapshots/task-4-after/tests/test_baseline.py	2026-08-26 01:09:50.652578707 -0300
@@ -0,0 +1,131 @@
+from __future__ import annotations
+
+import json
